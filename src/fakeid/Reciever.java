...
public class Reciever {
	...
	public void recieveData() {
		...
		hair = JOptionPane
				.showInputDialog("What is your hair color (Two letters)(For Example: Brown is BR and Blond is BL)?");

		eyes = JOptionPane
				.showInputDialog("What is your eye color (Two letters)(For Example: Brown is BR and Blue is BL)?");
	...
	public void create() {
		...
		Liscense l = new Liscense(dob, expiration, height, weight, hair, eyes, sex, name, address, pathChosen, city,
				zip, state);
		frame.add(l);
